...
public:
    Material()
        ...
        , _normals( glm::dvec3( -9999.0, -9999.0, -9999.0 ) )
		, _refl(0)
		, _trans(0)
        , _shininess( 0.0 ) 
		, _index(1.0) {}
    ...
    // returns 0 if not transmissive or kt^d i 
    glm::dvec3 transPow(double d, const isect& i) const;
    ...
    glm::dvec3 normals( const isect& i ) const { return _normals.value(i); }
    ...
    void setNormals( const MaterialParameter& normals )        { _normals = normals; }
...
private:
    ...
    MaterialParameter   _normals;              // normals
